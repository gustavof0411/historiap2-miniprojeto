...
public class HistoriaMiniprojeto {
        ...
        public static void main(String[] args) {
                ...
                continuar.nextLine();
                Capitulo capitulo1 = new Capitulo("[INTRODUÇÃO]", "[O início da aventura]", protagonista,
                                protagonista.nome(),
                                protagonista.vida());
                ...
                continuar.nextLine();
                System.out.println(
                                "Informante: O Rei Salaham solicita a sua ajuda para obter o Anel do Poder, roubado pelo"
                ...
                int escolha1 = capitulo1.escolher(continuar, continuar.nextLine(), "n", "s");
                ...
                if (escolha1 == 1) {
                        ...
                        continuar.nextLine();
                        System.out.println(
                                        "Se não o servir, você terá que lutará contra ele. Se vencer, se livrará dele.");
                        continuar.nextLine();
                        System.out.println(protagonista.nome()
                                        + ": Não tenho escolha. Devo tomar uma decisão imediatamente.");
                        continuar.nextLine();
                        ...
                        System.out.println();
                        System.out.print("Digite aqui:");
                        int escolha2 = capitulo1.escolher(continuar, continuar.nextLine(), "lutar", "servir");
                        ...
                        if (escolha2 == 1) {
                                ...
                                continuar.nextLine();
                                System.out.println(
                                                "Infelizmente, seu adversário estava forte demais para lutar contra.");
                                continuar.nextLine();
                                ...
                                continuar.nextLine();
                                System.out.println(
                                                mago.nome() + ": É uma pena. Nós poderíamos ser uma grande aliança.");
                                continuar.nextLine();
                                ...
                                continuar.nextLine();
                                System.out.println(
                                                "Com suas forças aliadas, vocês conseguem conquistar muitos mais territórios.");
                                continuar.nextLine();
                        ...
                        // Capítulo 2
                        Capitulo capitulo2 = new Capitulo("[O CAMINHO]", "[Indo para a torre do Mago do Mal]",
                                        protagonista,
                                        protagonista.nome(), protagonista.vida());
                        ...
                        continuar.nextLine();
                        System.out.println(
                                        "O caminho da esquerda, que passa pelos Bosques Calmos, é o caminho mais longo,"
                        ...
                        System.out.println();
                        System.out.print("Digite aqui:");
                        int escolha2 = capitulo2.escolher(continuar, continuar.nextLine(), "esquerda", "direita");

                        if (escolha2 == 1) {
                                System.out.println("Você decide seguir pelo caminho da esquerda.");
                                continuar.nextLine();
                                System.out.println(
                                                "A viagem é longa, precisando atravessar rios e matas, porém sem interrupções.");
                                continuar.nextLine();
                                ...
                                continuar.nextLine();
                                System.out.println(
                                                "Você pode aguardá-los saírem do local ou atacá-los instantaneamente.");
                                continuar.nextLine();
                                System.out.println("[ESCOLHAS]");
                                ...
                                System.out.println();
                                System.out.print("Digite aqui:");
                                int escolha3 = capitulo2.escolher(continuar, continuar.nextLine(), "atacar",
                                                "aguardar");
                                ...
                                if (escolha3 == 1) {
                                        ...
                                        continuar.nextLine();
                                        System.out.println(
                                                        "Felizmente, eles não são muito fortes, mas estão em grandes quantidades.");
                                        continuar.nextLine();
                                        ...
                                        continuar.nextLine();
                                        System.out.println(
                                                        "Após a luta, você consegue chegar até a torre do Mago do Mal.");
                                        continuar.nextLine();
                                } else if (escolha3 == 2) {
                                        System.out.println(
                                                        "Você decide aguardar os inimigos saírem do local, afinal, é melhor guardar"
                                                                        + " sua energia para o combate com o Mago do Mal.");
                                        continuar.nextLine();
                                        System.out.println(
                                                        "Passado algum tempo, você consegue passar pelo caminho, agora seguro.");
                                        continuar.nextLine();
                                ...
                                // Capítulo 3
                                Capitulo capitulo3 = new Capitulo("[O COMBATE]", "[Hora de derrotar o Mago do Mal]",
                                                protagonista, protagonista.nome(), protagonista.vida());
                                ...
                                if (escolha3 == 1) {
                                        System.out.println(
                                                        "Você chega momentos antes de o Mago ter adquirido todo o poder do Anel.");
                                        continuar.nextLine();
                                        System.out.println(
                                                        "Mago do Mal: Como OUSA interromper-me? Você será destruído!");
                                        continuar.nextLine();
                                        System.out.println(
                                        ...
                                        continuar.nextLine();
                                        protagonista.atacado(protagonista.nome(), protagonista.vida(),
                                                        protagonista.vida());
                                        ...
                                        continuar.nextLine();
                                        System.out.println(
                                                        "Felizmente, você guardou energia o suficiente quando decidiu aguardar os"
